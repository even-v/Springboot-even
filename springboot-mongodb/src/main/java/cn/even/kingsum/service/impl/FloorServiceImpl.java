...
import cn.even.kingsum.mapper.FloorMapper;
import cn.even.kingsum.service.IFloorService;
...
public class FloorServiceImpl extends BaseServiceImpl<FloorMapper,Floor> implements IFloorService {
    ...
    */
    @Override
    public <T extends Floor> IPage<Floor> list( T model){
        IPage<Floor> page = new Page<>(1,1);
    ...
    */
    ...
    private <T extends Floor> void setParam(QueryWrapper<Floor> wrapper, T model) {
        if (model == null) {
        return;
        }
    }
