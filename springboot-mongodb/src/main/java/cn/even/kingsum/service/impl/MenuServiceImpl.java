...
import cn.even.kingsum.entity.Menu;
import cn.even.kingsum.mapper.MenuMapper;
import cn.even.kingsum.service.IMenuService;
...
public class MenuServiceImpl extends BaseServiceImpl<MenuMapper,Menu> implements IMenuService {
    ...
    */
    @Override
    public <T extends Menu> IPage<Menu> list( T model){
    ...
    */
    ...
    private <T extends Menu> void setParam(QueryWrapper<Menu> wrapper, T model) {
        if (model == null) {
        return;
        }
    }
