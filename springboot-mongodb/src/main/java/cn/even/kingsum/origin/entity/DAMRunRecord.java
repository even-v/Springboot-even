...
/**
 * 本表记录监测控制设备每个设备的监测值只有一条记录存在，
 * @author Administrator
 *
 */
public class DAMRunRecord {

	public static final String collName = "dam_run_record";
	...
	/**
	 * 设备监测数据描述 81 未达下限 82 正常 83 超过数据上限 50 防火门异常关闭 51 防火门异常打开
	 **/
	...
	/**
	 * 控制设备控制状态 STARTING(1, "启动中"), STARTED(2, "启动完成"), STARTFAIL(3, "启动失败"),
	 * STOPPING(4, "停止中"), STOPPED(5, "停止完成"), STOPFAIL(6, "停止失败");
	 **/
	public static final String ctrlStatus = "ctrlStatus";
	/** 控制设备控制返回消息 **/
